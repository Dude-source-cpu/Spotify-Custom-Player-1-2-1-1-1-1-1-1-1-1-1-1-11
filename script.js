...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (prevBtn) prevBtn.addEventListener('click', () => sendCommand('previous'));
    ...
    // --- Playlist Functionality ---
    // Elements already selected at top: addToPlaylistBtn, playlistModal, playlistList
    ...
    if (myPlaylistsBtn) {
        myPlaylistsBtn.addEventListener('click', () => {
            isAddingMode = false;
            if (modalTitle) modalTitle.textContent = 'My Playlists';
            openPlaylistModal();
        });
    }
    ...
    let currentPin = '';
    const STATIC_PIN = '0915'; // Hardcoded PIN
